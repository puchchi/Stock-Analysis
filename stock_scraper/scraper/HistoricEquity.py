...
from scraper.spiders import HistoricEquitySpider
...
class kHistoricEquity:
    ...
    def __call__(self):
        ...
        process.crawl(HistoricEquitySpider.kHistoricEquitySpider, symbol=self.stockName, startDate=self.startDate, endDate=self.endDate,
...
class kCommand:
    ...
    def run_spider(self, queue, args):
        try:
            ...
            deferred = runner.crawl(HistoricEquitySpider.kHistoricEquitySpider, symbol=args[0][0], startDate=args[0][1], endDate=args[0][2],
    ...
    def get_name(self):
        return "Historic Equity Command"


if __name__ == "__main__":
    historicEquity = kHistoricEquity("SBIN", "01-Jan-2018", "01-Jun-2018", "HistoricStock", True)
    historicEquity()
