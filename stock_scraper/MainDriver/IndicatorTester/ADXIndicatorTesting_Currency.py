...
from MainDriver.IndicatorTester.IndicatorTesterClass import kIndicatorTesterClass_currency
from multiprocessing import Process, Queue

class kADXIndicatorTesting_currency(kIndicatorTesterClass_currency):

    def __init__(self, symbol, noOfDays=3):
        self.symbol = symbol
        self.filename = CSV_DATA_DIRECTORY + symbol + CSV_INDICATOR_EXTENSTION
        kIndicatorTesterClass_currency.__init__(self, self.symbol, "ADX", noOfDays)
